...
def parse_args():
    ...
    parser.add_argument("-a", action="store", dest="apk_path", default="workflow.json",
                        help="The file path to target APK")
    parser.add_argument("-o", action="store", dest="output_dir",
                        help="directory of output")
    parser.add_argument("-workflow", action="store", dest="workflow", default="workflow.json",
                        help="The workflow json file path")
...
def main():
    ...
    droidbot = DroidBot(
        ...
        workflow_file_path=opts.workflow,
